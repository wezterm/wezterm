...
pub fn derive_command_from_key_assignment(action: &KeyAssignment) -> Option<CommandDef> {
    Some(match action {
        ...
        DecreaseFontSizeByUnit(_) => CommandDef {
            brief: "Decrease font size".into(),
            doc: "Scales the font size smaller by chosen unit".into(),
            keys: vec![],
            args: &[ArgType::ActiveWindow],
            menubar: &["View", "Font Size"],
            icon: Some("md_format_size"),
        ...
        IncreaseFontSizeByUnit(_) => CommandDef {
            brief: "Increase font size".into(),
            doc: "Scales the font size larger by given unit".into(),
            keys: vec![],
            args: &[ArgType::ActiveWindow],
            menubar: &["View", "Font Size"],
            icon: Some("md_format_size"),
