...
#### Fixed
* X11: horizontal scroll wheel events (X buttons 6 and 7) were ignored, so
  `WheelLeft`/`WheelRight` mouse bindings never fired. They are now translated
  to horizontal wheel events. #7665
