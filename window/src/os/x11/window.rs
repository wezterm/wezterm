...
impl WindowOps for XWindow {
    ...
    fn present_software_frame_region(
        ...
        log::trace!(
            "present_software_frame_region: {}x{} at ({}, {}), {} bytes",
            width,
            height,
            dst_x,
            dst_y,
        ...
        XConnection::with_window_inner(window_id, move |inner| {
            ...
            // Send the partial pixel data using PutImage with dst_x/dst_y offset
            // This allows updating only a portion of the window
